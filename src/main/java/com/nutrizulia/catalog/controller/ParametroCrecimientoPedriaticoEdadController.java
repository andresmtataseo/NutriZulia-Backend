...
public class ParametroCrecimientoPedriaticoEdadController {

    private final IParametroCrecimientoPedriaticoEdadService parametroCrecimientoPedriaticoEdadService;
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista recuperada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ParametroCrecimientoPedriaticoEdadDto.class))),
    ...
    @GetMapping("v1/parametrosCrecimientosPedriaticoEdad")
    public ResponseEntity<List<ParametroCrecimientoPedriaticoEdadDto>> getParametrosCrecimientosPedriaticoEdad() {
