...
import com.nutrizulia.collection.dto.ConsultaDto;
import com.nutrizulia.collection.model.Consulta;
...
public interface ConsultaMapper {
    ...
    @Mapping(source = "especialidad.id", target = "especialidad_remiente_id")
    ...
    @Mapping(source = "especialidad_remiente_id", target = "especialidad.id")
