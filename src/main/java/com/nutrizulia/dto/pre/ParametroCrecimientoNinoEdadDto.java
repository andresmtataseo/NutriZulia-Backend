...
@Data
@Schema(name = "Parametro de Crecimiento de Niños por Edad", description = "Entidad que representa los parametros de crecimientos de niños de 5-19 años segun la OMS")
public class ParametroCrecimientoNinoEdadDto {
    ...
    @Schema(description = "Edad en meses a la que aplica el parametro", example = "200")
    @NotNull(message = "La edad en meses no puede ser nula")
    private Integer edad_mes;
