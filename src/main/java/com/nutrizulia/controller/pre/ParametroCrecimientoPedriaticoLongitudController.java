...
public class ParametroCrecimientoPedriaticoLongitudController {

    private final IParametroCrecimientoPedriaticoLongitudService parametroCrecimientoPedriaticoLongitudService;
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista recuperada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ParametroCrecimientoPedriaticoLongitudDto.class))),
    ...
    @GetMapping("v1/parametrosCrecimientosPedriaticoLongitud")
    public ResponseEntity<List<ParametroCrecimientoPedriaticoLongitudDto>> getParametrosCrecimientosPedriaticoLongitud() {
