...
public class DetalleMetabolicoService implements IDetalleMetabolicoService {
    ...
    public FullSyncResponseDTO<DetalleMetabolicoDto> findAllActive() {
        ...
        // Obtener detalles metabólicos filtrados por el usuario autenticado
        List<DetalleMetabolico> detallesActivos = detalleMetabolicoRepository.findAllActiveByUserId(usuario.getId());
