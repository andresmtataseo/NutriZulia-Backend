...
public class ParentescoController {
    ...
    @GetMapping(CATALOG_RELATIONSHIPS)
    public ResponseEntity<ApiResponseDto<List<ParentescoDto>>> getParentescos(HttpServletRequest request) {
        List<ParentescoDto> parentescos = parentescoService.getParentescos();
        
        ApiResponseDto<List<ParentescoDto>> response = ApiResponseDto.<List<ParentescoDto>>builder()
                .status(HttpStatus.OK.value())
                .message("Lista de parentescos recuperada exitosamente")
                .data(parentescos)
