...
public class TipoInstitucionController {
    ...
    public ResponseEntity<ApiResponseDto<List<TipoInstitucionDto>>> getTiposInstituciones(HttpServletRequest request) {
        List<TipoInstitucionDto> tiposInstituciones = tipoInstitucionService.getTiposInstituciones();
        
        ApiResponseDto<List<TipoInstitucionDto>> response = ApiResponseDto.<List<TipoInstitucionDto>>builder()
                .status(HttpStatus.OK.value())
                .message("Lista de tipos de instituciones recuperada exitosamente")
                .data(tiposInstituciones)
