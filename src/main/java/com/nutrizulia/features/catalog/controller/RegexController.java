...
import static com.nutrizulia.common.util.ApiConstants.REGEX_ALL;
...
public class RegexController {
    ...
    @GetMapping(REGEX_ALL)
    public ResponseEntity<List<RegexDto>> getRegex() {
        return ResponseEntity.ok(regexService.getAll());
    }
