...
public class ParametroCrecimientoPediatricoEdadController {
    ...
    public ResponseEntity<ApiResponseDto<List<ParametroCrecimientoPediatricoEdadDto>>> getParametrosCrecimientosPedriaticoEdad(HttpServletRequest request) {
        List<ParametroCrecimientoPediatricoEdadDto> parametros = parametroCrecimientoPedriaticoEdadService.getParametrosCrecimientosPedriaticosEdad();
        
        ApiResponseDto<List<ParametroCrecimientoPediatricoEdadDto>> response = ApiResponseDto.<List<ParametroCrecimientoPediatricoEdadDto>>builder()
                .status(HttpStatus.OK.value())
                .message("Lista de parámetros de crecimiento pediátrico por edad recuperada exitosamente")
                .data(parametros)
